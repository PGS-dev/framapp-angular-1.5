describe('mainPageComponentController test', () => {
    ...
    beforeEach(angular.mock.module('app.pages.mainPageModule'));
    ...
    beforeEach(inject((_firebase_, _$mdMedia_, _$componentController_, _dataService_) => {
        ...
        controller = _$componentController_('mainPageComponent', dataService);
    }));
    ...
    describe('check function in component', () => {
        ...
        it('should return object', () => {
            setTimeout(() => {
                expect(controller.getPromotedProducts()).toEqual(jasmine.any(Object));
            }, 1000);
        });
    });
});
